...
class CertificateParameters(BaseModel):
    RefNo: str = Field(..., description='Reference No.', examples=['BRRC/2018/236543'])
    TokenNo: str = Field(
        ...,
        description='Token ID',
        examples=[
            'Ex. 2924637nNv839 or date of issue in dd/mm/yyyy. if token number is less than 8 chars'
        ],
    )
...
class AlsblCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class AlsblCertificatePostResponse(BaseModel):
...
class AlsblCertificatePostResponse1(BaseModel):
...
class AlsblCertificatePostResponse2(BaseModel):
...
class AlsblCertificatePostResponse3(BaseModel):
...
class AlsblCertificatePostResponse4(BaseModel):
...
class AlsblCertificatePostResponse5(BaseModel):
...
class AlsblCertificatePostResponse6(BaseModel):
...
class ApptuCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class ApptuCertificatePostResponse(BaseModel):
...
class ApptuCertificatePostResponse1(BaseModel):
...
class ApptuCertificatePostResponse2(BaseModel):
...
class ApptuCertificatePostResponse3(BaseModel):
...
class ApptuCertificatePostResponse4(BaseModel):
...
class ApptuCertificatePostResponse5(BaseModel):
...
class ApptuCertificatePostResponse6(BaseModel):
...
class NooclCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class NooclCertificatePostResponse(BaseModel):
...
class NooclCertificatePostResponse1(BaseModel):
...
class NooclCertificatePostResponse2(BaseModel):
...
class NooclCertificatePostResponse3(BaseModel):
...
class NooclCertificatePostResponse4(BaseModel):
...
class NooclCertificatePostResponse5(BaseModel):
...
class NooclCertificatePostResponse6(BaseModel):
